...
function WhyShopWithUs() {
  ...
  <div className="flex flex-col md:mb-[16px] ">
    ...
    <div className="flex flex-col md:flex-row justify-evenly mt-[16px]">
      <div className="flex flex-col md:w-[43%] w-[90%] align-center ml-5">
      ...
      <div className="w-[43%] relative hidden xs:block">
      ...
      <div className="block xs:hidden">
        <div className="relative">
          <img src={oldStorePic} alt="old vacuum store" className="absolute top-5 left-[5%] w-[60%]"/>
          <img src={insideStore} alt="inside new vacuum store" className="absolute top-16 right-[5%] w-[60%]" />
        </div>
      </div>
    </div>    
  </div>
